# ============================================================
# Combined HOG + LBP + Optical Flow with Random Forest
# ============================================================
...
# ============================================================
# CUDA CHECK (for information only)
# ============================================================
...
MODEL_PATH = "rf_combined_hog_lbp_opticalflow_mean.pkl"
...
def train_and_evaluate(X, y, classes):
    print("\n🚀 Starting training and evaluation (Random Forest)...")
